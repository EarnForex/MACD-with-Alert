                ...
                const int &spread[])
{
    ...
    {
        BufferMain[i] = iMACD(Symbol(), PERIOD_CURRENT, MACDFastEMA, MACDSlowEMA, MACDSMA, MACDAppliedPrice, MODE_MAIN, i);
        BufferSignal[i] = iMACD(Symbol(), PERIOD_CURRENT, MACDFastEMA, MACDSlowEMA, MACDSMA, MACDAppliedPrice, MODE_SIGNAL, i);
    }
